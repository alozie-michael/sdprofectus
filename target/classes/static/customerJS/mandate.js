    ...
    $('.mandates').on('click', '[data-action="stopMandate"]', function (e) {
        ...
        if (response){
            ...
            $.ajax({
                ...
                url: "https://solutionsdelivery-directdebit.herokuapp.com/api/v1/solutionsdelivery/sd/stopMandate",
                dataType: 'json',
...
/*
        ...
        $.ajax({
            type: "GET",
            url: "https://solutionsdelivery-directdebit.herokuapp.com/api/v1/solutionsdelivery/sd/getBanks",
...
$('#setup').on('click', function (e) {
    ...
    $.ajax({
        ...
        url: "https://solutionsdelivery-directdebit.herokuapp.com/api/v1/solutionsdelivery/sd/mandateSetup",
        dataType: 'json',
        contentType: 'application/json',
        crossDomain: true,
        data: JSON.stringify({
        ...
        success: function (data) {
            if (data.statuscode && data.statuscode !== "040") {
                ...
                $.ajax({
                    type: "GET",
                    url: "https://solutionsdelivery-directdebit.herokuapp.com/api/v1/solutionsdelivery/sd/getMandates",
